  ...
  eks_managed_node_groups = {
    course-project = {
      ...
      iam_role_additional_policies = {
        policy_arn_1 = "arn:aws:iam::aws:policy/AmazonEKSWorkerNodePolicy"
        policy_arn_2 = "arn:aws:iam::aws:policy/AmazonEKS_CNI_Policy"
        policy_arn_3 = "arn:aws:iam::aws:policy/AmazonEC2ContainerRegistryReadOnly"
        policy_arn_4 = "arn:aws:iam::aws:policy/service-role/AmazonEBSCSIDriverPolicy"
      }
